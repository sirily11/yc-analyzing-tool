...
export default async function ReportPage({ params }: ReportPageProps) {
  ...
  return (
    <main className="report-page">
      ...
      <section className="report-map-section"><div className="report-section-heading"><span className="section-index">{dossier ? "03" : "01"} / Position</span><h2>Your company in the recent YC map</h2><p>The highlighted candidate is placed at the weighted center of its 12 nearest public-company profiles. Click any dot to inspect the company.</p></div><ReportMapExplorer reportId={reportId} report={report} companies={companies} /></section>
